...
void DVgrab::set_dst_filename(string dst_filename)
{
	m_dst_file_name = strdup( dst_filename.c_str() );
	set_format_from_name();
	std::cout << "Setting DV filename to " << dst_filename << std::endl ;
}
