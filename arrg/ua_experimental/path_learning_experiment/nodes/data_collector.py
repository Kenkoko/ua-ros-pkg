...
class Episode():
    ...
    def plot(self):
        ...
        plt.clf()  
        plt.subplot(211)      
        plt.plot(self.planned_x, self.planned_y, 'bo')        
        plt.plot(self.current_x, self.current_y, 'gv')       
...
#        plt.clf()
        plt.subplot(212)
        plt.plot(self.dist_t, self.dist_value)
        plt.plot(self.scan_t, self.scan_min, 'r')
