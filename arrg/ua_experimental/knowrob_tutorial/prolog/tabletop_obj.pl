...
create_tabletop_object(Match, Obj) :-
    ...
    jpl_call('edu.tum.cs.ias.knowrob.tutorial.ROSClient', 'objectPose', [Match], PoseAsArray),
    jpl_array_to_list(PoseAsArray, PoseAsList),
    ...
    % set pose
    set_perception_pose(Perception, PoseAsList),
...
id_to_type('cup', 'http://ias.cs.tum.edu/kb/knowrob.owl#Cup').
id_to_type('box', 'http://ias.cs.tum.edu/kb/knowrob.owl#Box-Container').
id_to_type('lego','http://ias.cs.tum.edu/kb/coffeecup.owl#LegoBlock').
