...
public class ROSClient {
    ...
    public static void main(String[] args) {
        ...
        {
            DatabaseModelPose m_pose = res.models.get(i).model_list.get(0);
            System.out.println(m_pose.model_id);
            System.out.println("Pos: " + m_pose.pose.pose.position.x + "," + m_pose.pose.pose.position.y + "," + m_pose.pose.pose.position.z);
        }
    }
