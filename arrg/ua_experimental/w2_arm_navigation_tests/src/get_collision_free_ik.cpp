...
int main(int argc, char **argv){
  ...
  ros::service::waitForService("wubble_left_arm_kinematics/get_constraint_aware_ik");
  ...
  ros::ServiceClient ik_client = rh.serviceClient<kinematics_msgs::GetConstraintAwarePositionIK>("wubble_left_arm_kinematics/get_constraint_aware_ik");
  ...
  gpik_req.ik_request.pose_stamped.pose.position.x = 0.6;
  gpik_req.ik_request.pose_stamped.pose.position.y = 0.1;
  gpik_req.ik_request.pose_stamped.pose.position.z = 0.2;
